    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="mt-3 text-gray-400 text-sm leading-relaxed">
          Share your ideas and business goals with us. We’ll help you create impactful digital solutions.
        </p>
      </div>
      ...
      {/* Submit Button */}
      <div className="relative z-10">
        <AnimatedButton type="submit" color="orange" disabled={loading} className="w-full">
          {loading ? (
            "Sending..."
          ) : (
      ...
      {/* Success Message */}
      {success && (
        <p className="relative z-10 text-center text-sm text-green-400">
